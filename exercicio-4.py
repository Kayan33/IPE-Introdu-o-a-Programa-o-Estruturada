...
print(f"\n{'*'*120}")
print(f"{'RESUMO DOS MUNICÍPIOS':^120}")
print(f"{'-'*120}")
print(f"{'  TOTAIS':<48}{'NOME':<30}{'QUANTIDADE':<30}{'PORCENTAGEM':<20}")
print(f"{'-'*120}")
print(f"{'  Município mais eleitores':<30}{mais_eleitor[0].upper():^40}{mais_eleitor[1]:^25}{'100%':>20}")
print(f"{'-'*120}")
print(f"{'  Mais votos em branco':<30}{mais_branco[0].upper():^40}{mais_branco[1]:^25}{mais_branco[2]:>20.2f}%")      
print(f"{'-'*120}")
print(f"{'  Mais votos nulos':<30}{mais_nulo[0].upper():^40}{mais_nulo[1]:^25}{mais_nulo[2]:>20.2f}%")
print(f"{'-'*120}")
