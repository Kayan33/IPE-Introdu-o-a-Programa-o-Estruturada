...
print(f'|----------------------------|--------------------------------------|-----------------------------------|-------------------------------------|')
print(f'| Município mais eleitores:  |                 {mais_eleitor[0].upper():<19}  |               {mais_eleitor[1]:<13}       |              100%                   |')
print(f'|----------------------------|--------------------------------------|-----------------------------------|-------------------------------------|')
print(f'| Mais votos em branco:      |                 {mais_branco[0].upper():<18}   |               {mais_branco[1]:<11}         |              {mais_branco[2]:.2f}%                  |')      
print(f'|----------------------------|--------------------------------------|-----------------------------------|-------------------------------------|')
print(f'| Mais votos nulos:          |                 {mais_nulo[0].upper():<16}     |               {mais_nulo[1]:<7}             |              {mais_nulo[2]:.2f}%                  |')
print(f'|----------------------------|--------------------------------------|-----------------------------------|-------------------------------------|')
print(f'| Mais votos válidos:        |                 {mais_validos[0].upper():<18}   |               {mais_validos[1]:<11}         |              {mais_validos[2]:.2f}%                 |')
print(f'|---------------------------------------------------------------------------------------------------------------------------------------------|')
